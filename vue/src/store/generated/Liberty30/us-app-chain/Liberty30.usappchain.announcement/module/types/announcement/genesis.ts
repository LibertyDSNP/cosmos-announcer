...
const baseGenesisState: object = { portId: '', broadcastCount: 0, sentAnnouncementCount: 0, timeoutAnnouncementCount: 0, publicationCount: 0 }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 8:
          ...
          break
        case 9:
          message.publicationCount = longToNumber(reader.uint64() as Long)
          break
        default:
