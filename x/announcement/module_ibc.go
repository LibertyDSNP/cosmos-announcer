...
func (am AppModule) OnRecvPacket(
	...
	var modulePacketData types.AnnouncementPacketData
	...
	case *types.AnnouncementPacketData_IbcBatchPacket:
		packetAck, err := am.keeper.OnRecvIbcBatchPacket(ctx, modulePacket, *packet.IbcBatchPacket)
		if err != nil {
...
func (am AppModule) OnAcknowledgementPacket(
	...
	switch packet := modulePacketData.Packet.(type) {
	case *types.AnnouncementPacketData_IbcBatchPacket:
		err := am.keeper.OnAcknowledgementIbcBatchPacket(ctx, modulePacket, *packet.IbcBatchPacket, ack)
		if err != nil {
			return nil, err
		}
		eventType = types.EventTypeIbcBatchPacket
...
func (am AppModule) OnTimeoutPacket(
	...
	switch packet := modulePacketData.Packet.(type) {
	case *types.AnnouncementPacketData_IbcBatchPacket:
		err := am.keeper.OnTimeoutIbcBatchPacket(ctx, modulePacket, *packet.IbcBatchPacket)
		if err != nil {
			return nil, err
		}
